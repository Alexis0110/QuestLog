 ...
 */
final class Version20250420170717 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE game (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, achievements VARCHAR(255) NOT NULL, steam_id INTEGER DEFAULT NULL)
        SQL);
        $this->addSql(<<<'SQL'
